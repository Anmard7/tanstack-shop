...
const getCartItemsCountFn = createServerFn({ method: 'GET' }).handler(
  async () => {
...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-background border-b border-slate-200 bg-white/80 backdrop-blur dark:border-slate-800 dark:bg-slate-950/80">
      <div className="mx-auto max-w-6xl px-4 py-3 items-center justify-between flex">
        <div className="flex items-center gap-3 ">
          ...
          <nav className="hidden sm:flex items-center gap-3 text-sm font-medium text-slate-700 dark:text-slate-200">
            <Link
              to="/"
